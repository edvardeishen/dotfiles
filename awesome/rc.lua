...
globalkeys = mytable.join(
    ...
    awful.key({ modkey }, "x", function ()
            os.execute(string.format("dmenu_run -i -fn 'Source Code Pro:pixelsize=12' -p 'Run:'  -nb '%s' -nf '%s' -sb '%s' -sf '%s'",
    ...
    awful.key({ modkey, "Shift"  }, "z", function ()
            os.execute(string.format("/home/edvard/power/dmenu-power.sh")) end,
